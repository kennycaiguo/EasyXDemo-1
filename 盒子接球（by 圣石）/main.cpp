...
// https://codebus.cn/contributor/a/ss-box-catching-balls
//
#include <graphics.h>
#include <conio.h>
#include <time.h>
...
void menu()
{
	...
	settextcolor(GREEN);
	outtextxy(450, 10, (TCHAR)introductiona);
	outtextxy(450, 30, (TCHAR)introductionb);
	outtextxy(450, 110, (TCHAR)runTime);
	outtextxy(450, 210, (TCHAR)receiveBallNum);
	outtextxy(450, 310, (TCHAR)copyRight);
	outtextxy(450, 410, (TCHAR)finishWorkDate);
}
...
int main()
{
	...
	outtextxy(220, 300, (TCHAR)"按任意键退出");
	EndBatchDraw();
